module fifo_controller_ext #(
    ...
    // extension: early-warning flags
    output logic                  almost_full,   // one write away from full
    output logic                  almost_empty   // one read away from empty
);
